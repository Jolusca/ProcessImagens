...
- [ ] como gerar e adicionar um ruído a uma imagem;
- [ ] aplicar as equações do exemplo para comprovar, passo a passo, os resultados que são obtidos para redução do ruído com as médias de 10, 20, 30, 50 e 100 imagens.
